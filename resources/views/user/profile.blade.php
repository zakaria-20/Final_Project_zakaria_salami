  ...
  @include("layouts.navbar")
   <div class="flex flex-col bg-gradient-to-b from-[#1f2937] to-[#111827] text-white font-['Lexend']">
      <main class="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-wrap sm:flex-nowrap p-4 gap-6 items-center justify-between">
          <div class="flex flex-wrap sm:flex-nowrap items-center gap-4">
            ...
            <div class="flex flex-col justify-center text-center sm:text-left">
              <p class="text-[#f9ac54] text-xl sm:text-2xl font-bold">{{ $user->name }}</p>
              <p class="text-white text-sm sm:text-base">{{ $user->height }} cm • {{ $user->weight }} kg</p>
              <p class="text-white text-sm sm:text-base">{{ $user->email }}</p>
            </div>
          </div>
          <a href="{{ route('profile.edit') }}">
            <button class="bg-[#f9ac54] text-[#111827] text-sm sm:text-base font-bold py-2 px-4 rounded-lg hover:bg-[#d98b45]">
              Edit Profile
            </button>
          </a>
        </div>
    
        <div class="flex flex-wrap md:flex-nowrap gap-y-10 md:gap-x-28 mt-11">
          <section class="w-full md:w-auto">
            <h2 class="text-lg sm:text-xl font-bold mb-4 border-b border-gray-600 pb-2">Personal Info</h2>
            <div class="flex flex-wrap gap-4">
              <div class="bg-[#1f2937] p-4 rounded-lg shadow-md flex items-center space-x-4 w-full sm:w-[48%] md:w-[17vw]">
                ...
                <div>
                  <p class="text-base sm:text-lg font-semibold">Height</p>
              ...
              <div class="bg-[#1f2937] p-4 rounded-lg shadow-md flex items-center space-x-4 w-full sm:w-[48%] md:w-[17vw]">
                ...
                <div>
                  <p class="text-base sm:text-lg font-semibold">Weight</p>
              ...
              <div class="bg-[#1f2937] p-4 rounded-lg shadow-md flex items-center space-x-4 w-full sm:w-[48%] md:w-[17vw]">
                ...
                <div>
                  <p class="text-base sm:text-lg font-semibold">Total Exercises</p>
              ...
              <div class="bg-[#1f2937] p-4 rounded-lg shadow-md flex items-center space-x-4 w-full sm:w-[48%] md:w-[17vw]">
                ...
                <div>
                  <p class="text-base sm:text-lg font-semibold">Total Joined Sessions</p>
          ...
          <section class="w-full">
            <h2 class="text-lg sm:text-2xl font-bold mb-4 border-b border-gray-600 pb-2">Calorie Burn Goal</h2>
            <div class="flex flex-col sm:flex-row items-center bg-[#1f2937] pt-2 rounded-lg shadow-lg">
              <div class="relative w-32 sm:w-48 h-32 sm:h-48 mx-auto mb-6">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                  <span class="text-lg sm:text-3xl font-bold text-white">{{ $progressPercentage }}%</span>
                </div>
              </div>
              <div class="text-center mt-4 sm:mt-0 sm:ml-6">
        ...
        <section class="mt-8">
          <h2 class="text-lg sm:text-xl font-bold mb-4 border-b border-gray-600 pb-2">Completed Exercises</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-[#1f2937] rounded-lg shadow-md p-4">
              <div class="aspect-square bg-center bg-cover rounded-lg overflow-hidden">
                <img src="{{ asset('/images/'.$exercise->image) }}" alt="{{ $exercise->name }}" class="w-full h-full object-cover">
              </div>
              <div class="mt-2">
                <h3 class="text-base md:text-lg font-semibold">{{ $exercise->name }}</h3>
                <p class="text-gray-300 text-sm md:text-base">{{ $exercise->calories_burned }} calories</p>
              </div>
            </div>
            @endforeach
          </div>
        ...
        <section class="mt-8">
          <h2 class="text-lg sm:text-xl font-bold mb-4 border-b border-gray-600 pb-2">Favorite Exercises</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
